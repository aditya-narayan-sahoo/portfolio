...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("adityasahoo246@gmail.com");
    setHasCopied(true);
    setTimeout(() => {
      setHasCopied(false);
    }, 2000);
      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        <article className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            />
            <div>
              <p className="grid-headtext">Hi, I&apos;m Aditya Narayan Sahoo</p>
              <p className="grid-subtext">
                I am a recent undergraduate with skills in both frontend and
